...
function extractISBN(identifiers) {
  ...
  return (
    isbn13?.identifier ||
    isbn10?.identifier ||
    `GBOOK-${Date.now()}-${Math.random().toString(36).substr(2, 9)}`
  );
}
...
async function main() {
  ...
  const books = await Promise.all([
    prisma.book.create({
      data: {
        ...
        description:
          "The first novel in the Harry Potter series follows Harry Potter, a young wizard who discovers his magical heritage.",
    ...
    prisma.book.create({
      data: {
        ...
        description:
          "A dystopian social science fiction novel set in a totalitarian society ruled by Big Brother.",
    ...
    prisma.book.create({
      data: {
        ...
        description:
          "A novel set in the Jazz Age that tells the story of Jay Gatsby and his unrequited love.",
    ...
    prisma.book.create({
      data: {
        ...
        description:
          "The first volume of the epic fantasy trilogy following Frodo Baggins.",
    ...
    prisma.book.create({
      data: {
        ...
        description:
          "Detective Hercule Poirot investigates a murder aboard the famous train.",
    ...
    prisma.book.create({
      data: {
        ...
        description:
          "A landmark novel chronicling seven generations of the Buendía family.",
    ...
    prisma.book.create({
      data: {
        ...
        description:
          "The story of an aging Cuban fisherman and his epic battle with a giant marlin.",
    ...
    prisma.book.create({
      data: {
        ...
        description:
          "A modernist novel detailing a day in the life of Clarissa Dalloway in post-WWI England.",
    ...
    prisma.book.create({
      data: {
        ...
        description:
          "Harry returns to Hogwarts for his second year to face a mysterious monster.",
    ...
    prisma.book.create({
      data: {
        ...
        description:
          "Bilbo Baggins embarks on an unexpected journey to reclaim treasure from a dragon.",
    ...
    prisma.book.create({
      data: {
        ...
        description:
          "A story about the Dashwood sisters navigating love, heartbreak, and society.",
        tags: ["classic", "romance", "british-literature"],
      },
    }),
    prisma.book.create({
      data: {
        ...
        description:
          "Ten strangers are lured to an island where they are mysteriously murdered one by one.",
  ...
  const memberData = [
    {
      ...
      name: "John",
      phone: "+1234567892",
      address: "789 Reader Lane, Book City, BC 34567",
    },
    {
      ...
      name: "Jane",
      phone: "+1234567893",
      address: "321 Novel Street, Story Town, ST 45678",
    },
    {
      ...
      name: "Mike",
      phone: "+1234567894",
      address: "654 Chapter Road, Fiction City, FC 56789",
    },
    {
      ...
      name: "Emily",
      phone: "+1234567895",
      address: "987 Page Boulevard, Read City, RC 67890",
    },
    {
      ...
      name: "David",
      phone: "+1234567896",
      address: "147 Bookmark Drive, Library City, LC 78901",
    },
  ];
  ...
  console.log(
    `   - ${testUsers.length} users (1 admin, 1 librarian, ${testUsers.length - 2} members)`,
  );
  console.log(`   - ${members.length} memberships`);
  console.log(
    `   - ${loans.length} loans (${loans.filter((l) => l.status === "borrowed").length} active, ${loans.filter((l) => l.status === "returned").length} returned)`,
  );
