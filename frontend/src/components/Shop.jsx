...
const Shop = () => {
  ...
  const displayBooks = getDisplayBooks().filter(
    (book) =>
        ...
        <div className="container">
          ...
          <div className="header-actions">
            ...
            <button
              type="button"
              className={
                localStorage.getItem("user") ? "dashboard-btn" : "login-btn"
              }
